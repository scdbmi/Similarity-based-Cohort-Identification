...
% algorithm which is in "TPModelingandTesting.m". Please ensure that the 
% path is correctly set to the directory containing all the .csv files
% containing the OMOP CDM data before running this script. This should
% be the "Modeling_withoutlabs" sub-folder within the "Cohort 
...
% Demographics
    demo=readtable('Seedpatients_demo.csv','ReadVariableNames',false);
 ...
 % Conditions
    cond=readtable('Seedpatients_cond.csv','ReadVariableNames',false);
...
% Drugs
    drugs=readtable('Seedpatients_drugs.csv','ReadVariableNames',false);
...
% Procedures
    proc=readtable('Seedpatients_proc.csv','ReadVariableNames',false);
...
save('Seedpatients_data.mat','data','datademo','datacond','datadrug','dataproc','conceptids');
