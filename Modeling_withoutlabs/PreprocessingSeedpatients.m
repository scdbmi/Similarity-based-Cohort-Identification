...
% Demographics
    demo=readtable('Seedpatients_demo.csv','ReadVariableNames',true);
 ...
 % Conditions
    cond=readtable('Seedpatients_cond.csv','ReadVariableNames',true);
...
% Drugs
    drugs=readtable('Seedpatients_drugs.csv','ReadVariableNames',true);
...
% Procedures
    proc=readtable('Seedpatients_proc.csv','ReadVariableNames',true);
