...
% identification algorithm script, i.e. "TPModelandTest.m".
...
% Set the start date of the experiments to the recruitment date input by the user
...
% Demographics
    demo=readtable([folder '\Randomsample_demo.csv'],'ReadVariableNames',true);
...
% Conditions
    cond=readtable([folder '\Randomsample_cond.csv'],'ReadVariableNames',true);
...
% Labs             
    labs=readtable([folder '\Randomsample_labs.csv'],'ReadVariableNames',true);
...
% Drugs
    drugs=readtable([folder '\Randomsample_drugs.csv'],'ReadVariableNames',true);
...
% Procedures       
    proc=readtable([folder '\Randomsample_proc.csv'],'ReadVariableNames',true);
...
save([folder '\Randomsample_data.mat'],'data','datademo','datalab','datacond','datadrug','dataproc','conceptids');
